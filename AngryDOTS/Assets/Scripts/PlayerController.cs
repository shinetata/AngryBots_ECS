...
public class PlayerController : MonoBehaviour
{
    ...
    bool isDead;
    bool useECS;
    IECSWorld manager; // Member to hold an EntityManager reference
    IEntity playerDataEntity; // Member to hold the ID of the player data entity
    void Awake()
    {
    ...
    void CreateEntity()
    {
        ...
        manager = PGDGameContext.GetWorld();
        ...
        // Set the component data we just created for the entity we just created
        playerDataEntity.AddComponent(h);
    }
    ...
    void UpdateEntity()
    {
        ...
        if (playerDataEntity == PGDGameContext.NullEntity)
            return;
        // Use the player's data entity to find the player's Health data component
        Health health = playerDataEntity.GetComponent<Health>();
